...
import { claim_component } from "svelte/internal";
    ...
    function onClickedAdd(){        
        ...
        var ParaentSize = Parent.getBoundingClientRect();
    ...
    function onClickedRefresh(){
        ...
        if(Parent.childElementCount > 0){
            var Obj = Parent.childNodes[Parent.childElementCount - 1];
...
<div>
    ...
    <div class="divBtnSection">
        <button class="btnSide" type="button" on:click="{onClickedAdd}">추가</button>
